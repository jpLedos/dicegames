...
let img;// variable image for dice display
let target = 100// target to win the party

//variables for the party
...
//reset variables for a new party  
function newParty() {
  // variables reinit
  round = 0;
  globals = [0,0];
...
newPartybutton.addEventListener('click', () => {
  document.location.reload(); //page reload for a new party
})